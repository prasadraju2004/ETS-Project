                            ...
                            >
                                ...
                                <div className="flex-grow p-8 flex flex-col justify-between relative">
                                    ...
                                    <div className="flex items-center gap-3">
                                        <button className="flex-grow flex items-center justify-center px-6 py-3 bg-slate-900 text-white rounded-xl font-black text-sm hover:bg-indigo-600 transition-all shadow-lg shadow-slate-100 relative group overflow-hidden">
